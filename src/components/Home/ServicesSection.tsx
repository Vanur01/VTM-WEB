      ...
      features: [
        {
          ...
          description: 'tailored designs that adapt seamlessly across all devices'
        },
        {
      ...
      <div className="max-w-7xl w-full">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
            ...
            <CometCard className="w-full lg:w-1/2">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">{services[0].title}</h3>
              </div>
            ...
            <CometCard className="w-full lg:w-1/2">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">{services[1].title}</h3>
              </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
            ...
            <CometCard className="w-full lg:w-[60%]">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">{services[2].title}</h3>
              </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
            ...
            <CometCard className="w-full lg:w-[60%]">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">{services[5].title}</h3>
              </div>
          ...
          <CometCard className="w-full">
            ...
            <a href="/contact" className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-purple-600 text-white hover:bg-purple-500 transition-all duration-300 group-hover:scale-105 font-semibold text-sm sm:text-base">
