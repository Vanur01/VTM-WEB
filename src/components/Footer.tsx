    ...
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8" style={{ backgroundColor: '#0B0011' }}>
      <div className="w-full max-w-7xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12" style={{ background: 'linear-gradient(135deg, #6B21A8 0%, #4C1D95 100%)' }}>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          <div className="max-w-md">
            <p className="text-purple-200 text-sm sm:text-sm md:text-md leading-relaxed">
              Welcome to our firm that specializes in Creative Advertisement, Digital Marketing, Website Development.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div>
            <h3 className="text-white text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Contact Us</h3>
            ...
            <div className="mb-4 sm:mb-6">
              <div className="flex items-start gap-3 text-purple-200">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base leading-relaxed">
                    Lower Ground, Plot No. 26, Sector 20<br />
                    Dwarka, Delhi, 110077
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center gap-3 text-purple-200 mb-3 sm:mb-4">
              ...
              <a href="tel:+917077004890" className="text-sm sm:text-base hover:text-white transition-colors">
                +91-7077004890
              </a>
            </div>
            ...
            <div className="flex items-center gap-3 text-purple-200 mb-6 sm:mb-8">
              ...
              <a href="mailto:info@vanurmedia.com" className="text-sm sm:text-base hover:text-white transition-colors">
                info@vanurmedia.com
              </a>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li>
                <Link href="/about" className="text-purple-200 hover:text-white transition-colors text-sm sm:text-base">
                  About
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-purple-200 hover:text-white transition-colors text-sm sm:text-base">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/work" className="text-purple-200 hover:text-white transition-colors text-sm sm:text-base">
                  Works
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-purple-200 hover:text-white transition-colors text-sm sm:text-base">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <h3 className="text-white text-lg sm:text-xl font-semibold mb-4 sm:mb-6">Find Us</h3>
