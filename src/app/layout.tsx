...
export const metadata: Metadata = {
  ...
  title: {
    default: "Vanur Media - Web Development & Software Solutions",
    template: "%s | Vanur Media",
  },

  description:
    "Vanur Media is a leading web development agency specializing in custom web applications, mobile app development, SEO optimization, and innovative digital solutions for businesses worldwide.",
  ...
  openGraph: {
    ...
    url: "https://vanurmedia.com",
    siteName: "Vanur Media",
    title: "Vanur Media - Web Development & Software Solutions",
    description:
      "Build scalable web and mobile applications with Vanur Media. We deliver custom software solutions designed for business growth.",
    images: [
      {
        url: "/images/logo-1.png",
        width: 1200,
        height: 630,
        alt: "Vanur Media - Web & Software Solutions",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Vanur Media - Web Development & Software Solutions",
    description:
      "Expert web development, mobile app development, and scalable software solutions tailored to your business needs.",
    images: ["/images/logo-1.png"],
  },
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    logo: "https://vanurmedia.com/images/logo.png",
    description:
      "Vanur Media provides custom web development, mobile applications, and scalable software solutions for businesses.",
    contactPoint: {
      "@type": "ContactPoint",
